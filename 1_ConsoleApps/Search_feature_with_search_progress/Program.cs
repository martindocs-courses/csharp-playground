        ...
        case "2":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (var term in animalsArray)
                    {
                        if (term.Trim() != "")
                        {
                            for (int j = 2; j > -1; j--)
            ...
            if (noMatchesDog)
            {
                Console.WriteLine("None of our dogs are a match found for: " + String.Join(", ", animalsArray));
            }
